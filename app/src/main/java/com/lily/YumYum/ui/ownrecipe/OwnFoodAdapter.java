...
public class OwnFoodAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final Context mContext;

    private List<Food> mFoodList;

    private OwnFoodListViewModel mViewModel;

    public OwnFoodAdapter(Context context, List<Food> foods, OwnFoodListViewModel viewModel) {
        mContext = context;
